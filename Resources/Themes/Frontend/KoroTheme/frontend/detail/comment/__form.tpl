...
{block name='frontend_detail_comment_post_title'}
    <div id="product--publish-comment" class="content--title panel--title is--underline form_head pre-headline">
        <div class="mobile_visible">
            {s name="DetailCommentHeaderWriteReview"}{/s} ✏️
...
<div class="content--title is--underline panel--title headline">
    {s name="DetailCommentHeaderWriteReviewHeadline"}Sag uns Deine Meinung{/s}
</div>
        ...
        <form method="post" action="{url action='rating' sArticle=$sArticle.articleID sCategory=$sArticle.categoryID}#detail--product-reviews" class="content--form review--form">
            ...
            {block name='frontend_detail_comment_input_rating'}
                <div class="field--select review--field ">
                    ...
                    <input name="sVoteStars" type="hidden">
                    <div class="product--rating flixx-article-rating js-flixx-article-rating"></div>
                </div>
                <!-- <div class="field--select review--field">
            ...
            {/block}
            <div class="captcha--notice notice">{s name="DetailReviewNotice"}{/s}</div>
            {* Captcha *}
                ...
                <div class="review--actions">
                    ...
                    {block name='frontend_detail_comment_input_actions_submit'}
                        <button type="submit" class="" name="Submit">
                            <!-- {s name="DetailCommentActionSave"}{/s} -->{s name="DetailCommentSubmitButton"}{/s}
                        </button>
                    {/block}
                </div>
            {/block}
